...
def main():
	...
	progname_cooked = os.path.splitext(os.path.basename(sys.argv[0]))[0]

	# to show the correct help text
	towikidefault = tocsvdefault = ''
	if progname_cooked == 'csv2wiki':
		towikidefault = '(default) '
	...
	if args.towiki and not args.tocsv:
		direction = 'towiki'
	elif args.tocsv and not args.towiki:
		direction = 'tocsv'
